...
coverpkg="github.com/calmw/ethereum/..."
...
repo=$GOPATH/src/github.com/calmw/ethereum
compile_fuzzer github.com/calmw/ethereum/accounts/abi \
  FuzzABI fuzzAbi \
  $repo/accounts/abi/abifuzzer_test.go

compile_fuzzer github.com/calmw/ethereum/common/bitutil \
...
compile_fuzzer github.com/calmw/ethereum/eth/protocols/snap \
...
compile_fuzzer github.com/calmw/ethereum/tests/fuzzers/bn256 \
...
compile_fuzzer github.com/calmw/ethereum/tests/fuzzers/txfetcher \
  Fuzz fuzzTxfetcher \
  $repo/tests/fuzzers/txfetcher/txfetcher_test.go

compile_fuzzer github.com/calmw/ethereum/tests/fuzzers/bls12381 \
...
compile_fuzzer github.com/calmw/ethereum/tests/fuzzers/secp256k1 \
  Fuzz fuzzSecp256k1\
  $repo/tests/fuzzers/secp256k1/secp_test.go

compile_fuzzer github.com/calmw/ethereum/eth/protocols/eth \
